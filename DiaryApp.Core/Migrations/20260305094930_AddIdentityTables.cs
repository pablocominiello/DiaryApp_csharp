    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "learning .net mvc with Punjha", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Learning .Net MVC" },
                    { 2, "Learning Migrations mvc with Punjha", new DateTime(2025, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Learning Migrations" },
                    { 3, "Learning Input database with Punjha", new DateTime(2025, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Input database" }
                });
